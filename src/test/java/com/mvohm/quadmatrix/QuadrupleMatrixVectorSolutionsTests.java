...
/**
 * QuadrupleMatrixVectorSolutionsTest.java
 *
...
public class QuadrupleMatrixVectorSolutionsTests {
...
//                                                123321;
  ...
  private static final int      REFINEMENT_TEST_ITERATIONS      = 100;
  private static final int      LARGE_MATRIX_SIZE               = 155; // To take my machine approx. 30 s per a long test, 90 s total

  private static final int      SCALING_TEST_ITERATIONS         = 500;
  private static final int      SCALING_MATRIX_SIZE             =  90; // To take my machine approx. 30 s
  private static final double   SCALING_RANGE                   =   1.0e100;


  /**
   * To estimate the effectiveness (refinement ratio) of iterative refinements used by {@link QuadrupleMatrix#solveAccurately(double[])}
   * and {@link QuadrupleMatrix#solveSPDAccurately(double[])} methods,
  ...
  private static final double EXPECTED_MIN_IMPROVEMENT         =   2.00;
  private static final double EXPECTED_AVR_IMPROVEMENT         =  35.00;

  private static final double EXPECTED_MIN_SPD_IMPROVEMENT     =   2.00;
  private static final double EXPECTED_AVR_SPD_IMPROVEMENT     =   5.00;
  ...
  private static final Quadruple[]    sampleSolvableMatrixAnotherSolutionAsQuadruples = sampleSolvableMatrixAnotherSolutionAsQuadruples();

  private static final Quadruple[]    sampleSpdSolvableMatrixSolutionAsQuadruples   = sampleSpdSolvableMatrixSolutionAsQuadruples();

  private static final Quadruple[]    sampleSpdSolvableMatrixAnotherSolutionAsQuadruples = sampleSpdSolvableMatrixAnotherSolutionAsQuadruples();
  ...
  void testSolveReturnsCorrectSolution() {
    printMethodName();
    final Quadruple[] expectedSolution = sampleSolvableMatrixSolutionAsQuadruples;
    final double expectedError = ERROR_TOLERANCE;

    final QuadrupleMatrix matrix = new QuadrupleMatrix(sampleSolvableMatrixData);
    final Quadruple[] actualSolution = convertToQuadruples(matrix.solve(sampleSolvableMatrixVector));
  ...
  void testSolveWithQuadruplesReturnsCorrectSolution() {
    ...
    final QuadrupleMatrix matrix = new QuadrupleMatrix(sampleSolvableMatrixData);
    final Quadruple[] actualSolution = convertToQuadruples(matrix.solve(sampleSolvableMatrixVectorAsQuadruples));
    final ErrorSet actualErrors = findErrors(expectedSolution, actualSolution, OUTPUT_ENABLED);
  ...
  void testSolveWithBigDecimalsReturnsCorrectSolution() {
    ...
    final QuadrupleMatrix matrix = new QuadrupleMatrix(sampleSolvableMatrixData);
    final Quadruple[] actualSolution = convertToQuadruples(matrix.solve(sampleSolvableMatrixVectorAsBigDecimals));
    final ErrorSet actualErrors = findErrors(expectedSolution, actualSolution, OUTPUT_ENABLED);
  ...
  void testSolveSPDWithNullArgumentThrowsException() {
    final QuadrupleMatrix matrix = new QuadrupleMatrix(sampleSpdSolvableMatrixData);
  ...
  void testSolveSPDWithNonPdMatrixThrowsException() {
    final QuadrupleMatrix matrix = new QuadrupleMatrix(sampleNonPositivelyDefinedMatrixData);
  ...
  void testSolveSPDWithAsymmetricMatrixThrowsException() {
    final QuadrupleMatrix matrix = new QuadrupleMatrix(sampleNonSymmetricMatrixData);
  ...
  void testSolveSPDReturnsCorrectSolution() {
    printMethodName();
    final Quadruple[] expectedSolution = sampleSpdSolvableMatrixSolutionAsQuadruples;
    final double expectedError = ERROR_TOLERANCE;

    final QuadrupleMatrix matrix = new QuadrupleMatrix(sampleSpdSolvableMatrixDataAsQuadruples);
    final Quadruple[] actualSolution = convertToQuadruples(matrix.solveSPD(sampleSpdSolvableMatrixVectorAsQuadruples));
    final ErrorSet actualErrors = findErrors(expectedSolution, actualSolution, OUTPUT_ENABLED);
  ...
  void testSolveSPDWithBigDecimalsReturnsCorrectSolution() {
    ...
    final QuadrupleMatrix matrix = new QuadrupleMatrix(sampleSpdSolvableMatrixDataAsQuadruples);
    final Quadruple[] actualSolution = convertToQuadruples(matrix.solveSPD(sampleSpdSolvableMatrixVectorAsBigDecimals));
    final ErrorSet actualErrors = findErrors(expectedSolution, actualSolution, OUTPUT_ENABLED);
  ...
  void testSolveAccuratelyReturnsCorrectSolution() {
    ...
    final QuadrupleMatrix matrix = new QuadrupleMatrix(sampleSolvableMatrixData);
    final Quadruple[] actualSolution = convertToQuadruples(matrix.solveAccurately(sampleSolvableMatrixVector));
    final ErrorSet actualErrors = findErrors(expectedSolution, actualSolution, OUTPUT_ENABLED);
  ...
  void testSolveSPDAccuratelyReturnsCorrectSolution() {
    ...
    final QuadrupleMatrix matrix = new QuadrupleMatrix(sampleSpdSolvableMatrixDataAsQuadruples);
    final Quadruple[] actualSolution = convertToQuadruples(matrix.solveSPDAccurately(sampleSpdSolvableMatrixVectorAsQuadruples));
    final ErrorSet actualErrors = findErrors(expectedSolution, actualSolution, OUTPUT_ENABLED);
  ...
  void testGetSolutionReturnsACopyOfInternalData() {
    ...
    tmpSolution[0] = new Quadruple(12345).add(tmpSolution[0].doubleValue());
    final Number[] actualSolution = matrix.getSolution();
  ...
  void testRepeatedsolveReturnsCorrectSolution() {
    printMethodName();
    final Quadruple[] expectedSolution = sampleSolvableMatrixAnotherSolutionAsQuadruples;
    final double expectedError = ERROR_TOLERANCE;

    final QuadrupleMatrix matrix = new QuadrupleMatrix(sampleSolvableMatrixDataAsQuadruples);
    matrix.solve(sampleSolvableMatrixVectorAsQuadruples);
    final Quadruple[] actualSolution = convertToQuadruples(matrix.solve(sampleSolvableMatrixAnotherVector));
    final ErrorSet actualErrors = findErrors(expectedSolution, actualSolution, OUTPUT_ENABLED);
  ...
  void testRepeatedSolveSPDReturnsCorrectSolution() {
    printMethodName();
    final Quadruple[] expectedSolution = sampleSpdSolvableMatrixAnotherSolutionAsQuadruples; // AsQuadruples;
    final double expectedError = ERROR_TOLERANCE;

    final QuadrupleMatrix matrix = new QuadrupleMatrix(sampleSpdSolvableMatrixDataAsQuadruples);
    matrix.solveSPD(sampleSpdSolvableMatrixVectorAsQuadruples);
    final Quadruple[] actualSolution = convertToQuadruples(matrix.solveSPD(sampleSpdSolvableMatrixAnotherVectorAsQuadruples));
    final ErrorSet actualErrors = findErrors(expectedSolution, actualSolution, OUTPUT_ENABLED);
  ...
  void testSolveAfterSolveSPDReturnsCorrectSolution() {
    ...
    final Quadruple[] actualSolution = convertToQuadruples(matrix.solve(sampleSpdSolvableMatrixVectorAsQuadruples));
    final ErrorSet actualErrors = findErrors(expectedSolution, actualSolution, OUTPUT_ENABLED);
  ...
  void testSolveSpdAfterSolvingLUreturnsCorrectSolution() {
    printMethodName();
    final Quadruple[] expectedSolution = sampleSpdSolvableMatrixAnotherSolutionAsQuadruples;
    final double expectedError = ERROR_TOLERANCE;

    final QuadrupleMatrix matrix = new QuadrupleMatrix(sampleSpdSolvableMatrixDataAsQuadruples);
    matrix.solve(sampleSpdSolvableMatrixVectorAsQuadruples);
    final Quadruple[] actualSolution = convertToQuadruples(matrix.solveSPD(sampleSpdSolvableMatrixAnotherVectorAsQuadruples));
    final ErrorSet actualErrors = findErrors(expectedSolution, actualSolution, OUTPUT_ENABLED);
  ...
  private static OperationComparator makeAccurateVsSimpleSPDSolutionComparator() {
    return new OperationComparator(
        ...
        MatrixData::quadrupleSPDSolutionErrors,
        MatrixData::quadrupleAccurateSPDSolutionErrors
        );
  }
  ...
  private static OperationComparator makeScaledVsUnscaledLuSolutionComparator() {
    return new OperationComparator(
        ...
        MatrixData::quadrupleLuSolutionWithoutScalingErrors,
  ...
  private static OperationComparator makeAccurateVsSimpleVectorSolutionComparator() {
    return new OperationComparator(
        ...
        MatrixData::quadrupleLuSolutionWithScalingErrors,
        MatrixData::quadrupleAccurateLUSolutionWithScalingErrors
        );
  }
